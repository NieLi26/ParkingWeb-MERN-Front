...
export default function Login() {
    ...
    if (Object.values(auth).length !== 0) return <Navigate to="/" />
    ...
    const handleSubmit = async e => {
        ...
        const errores = validarLogin(form)
    ...
    return (
        <>
            <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 bg-cover bg-center h-screen" style={{ backgroundImage: "url('parking2-bg.jpg')" }}>
