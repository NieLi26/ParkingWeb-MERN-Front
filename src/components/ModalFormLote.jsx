...
import validarCrearLote from "../validation/validarCrearLote";
...
const ModalFormLote = () => {
    ...
    const handleSubmit = async e => {
        e.preventDefault()
        const errores = validarCrearLote(form)
  ...
  return (
    ...
    <Transition.Root show={ modalFormLote } as={Fragment}>
        <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalCrearLote}>
