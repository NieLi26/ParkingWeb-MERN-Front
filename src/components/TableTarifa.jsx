                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    {tarifas.map((tarifa) => (
                      <tr key={tarifa._id}>
                        ...
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{tarifa.precioMinuto}</td>

                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{tarifa.precioBase}</td>

                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{tarifa.desdeMinuto}</td>
