...
const ModalEliminarLote = () => {

    const { modalEliminarLote, handleModalEliminarLote, eliminarLote, lote, cargando } = useParking()
 
    return (
        <Transition.Root show={ modalEliminarLote } as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalEliminarLote }>
                    ...
                    >
                            ...
                            <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                                <button
                                    ...
                                    onClick={handleModalEliminarLote}
                                >
