...
const ModalAnularReserva = () => {
    const { handleModalAnularReserva, modalAnularReserva, cargando, anularReserva, handleOpenMenu } = useParking();
  ...
  return (
    ...
    <Transition.Root show={ modalAnularReserva } as={Fragment}>
        <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalAnularReserva}>
                ...
                >
                        ...
                        <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                            <button
                                ...
                                onClick={ handleModalAnularReserva }
                            >
