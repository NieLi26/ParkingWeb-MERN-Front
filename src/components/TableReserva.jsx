...
export default function TablePago() {
    ...
    const { reservasPaginadas, handleModalEliminarPago, handleModalEditarTarifa, handleModalCrearTarifa } = useParking()
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    {reservasPaginadas.map((reserva) => (
                      <tr key={reserva._id}>
                        ...
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{reserva.entrada ? formatearFecha(reserva.entrada) : 'Sin Registro'}</td>

                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{reserva.salida ? formatearFecha(reserva.salida) : 'Sin Registro'}</td>
